...
INSTALLED_APPS = [
    # "widget_tweaks",  # Uncomment if you have installed django-widget-tweaks
...
DEFAULT_FROM_EMAIL = 'no-reply@aidi-journal.local'

# Для реальной отправки по SMTP раскомментируйте и впишите свои данные:
